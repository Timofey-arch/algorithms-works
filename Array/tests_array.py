...
TEST_APPEND = [
    ('d', [], 1, array('d', [1.0])),
    ('d', [1.0], 1, array('d', [1.0, 1.0])),
    ('d', [2.0], 1.0, array('d', [2.0, 1.0])),
    ('d', [2.0, 5.0], 1, array('d', [2.0, 5.0, 1.0])),
    ('i', [], 1, array('i', [1])),
    ('i', [1], 1, array('i', [1, 1])),
    ('i', [2], 1, array('i', [2, 1])),
...
TEST_INSERT = [
    ('d', [], 0, 8, array('d', [8.0])),
    ('d', [1.0], 0, 8, array('d', [8.0, 1.0])),
    ('d', [2.0, 5.0], 1, 8, array('d', [2.0, 8.0, 5.0])),
    ('d', [2.0, 5.0], 2, 8, array('d', [2.0, 5.0, 8.0])),
    ('d', [2.0, 5.0], 10, 8, array('d', [2.0, 5.0, 8.0])),
    ('d', [2.0, 5.0], -1, 8, array('d', [2.0, 8.0, 5.0])),
    ('d', [2.0, 5.0], -2, 8, array('d', [8.0, 2.0, 5.0])),
    ('i', [], 0, 8, array('i', [8])),
    ('i', [1], 0, 8, array('i', [8, 1])),
    ('i', [2, 5], 1, 8, array('i', [2, 8, 5])),
    ('i', [2, 5], 2, 8, array('i', [2, 5, 8])),
    ('i', [4, 4], 10, 8, array('i', [4, 4, 8])),
