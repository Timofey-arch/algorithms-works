...
TEST_STR = [
    ...
    ['aa', 'aa', 'aa', 'ab', 'ac', 'b'],
    ['e', 'd', 'c', 'b', 'a'],
    ['abc', 'a', 'foo', 'bar', 'booz', 'baz', 'spam', 'love', 'cum'],
    ['abc', 'abc', 'abc'],
    [''],
]
...
class TestSort(unittest.TestCase):
    ...
    def test_sort_number_increase(self):
        ...
        for data in TEST_NUMBER:
            with self.subTest():
                self.assertEqual(my_sort.my_sort(data, visualization=True), sorted(data))
    ...
    def test_sort_number_decrease(self):
        ...
        for data in TEST_NUMBER:
            with self.subTest():
                self.assertEqual(
                    my_sort.my_sort(data, reverse=True, visualization=True),
