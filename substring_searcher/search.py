...
def main():
    """
    -В мэйне твоя сила и мудрость
    -Вы используете мэйн?
    -Да)
    -А какие сигнатуры предпочитаете?
    -Да обычные, вон ничего не возвращает, нормальный мэйн, пацанский, че, использовать можно
    -Похвалите еще мэйн
    -Ну как его похвалить? Ну зашибись мэйн, классный мэйн, как его еще похвалить блин?)Хехе
    -А еще пара красивых слов?
    -Офигенный мэйн
    -Спасибо
    -Да на здоровье)
    :return: Ничего
    ...
    parser.add_argument('-case_sensitivity', type=bool, help='Чуствительность к регистру', default=True)
    ...
    print('Substring(s): ' + str(args.substr))
